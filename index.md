...
*Simulación magnetohidrodinámica (MHD) de la formación de un disco de acreción alrededor de un agujero negro supermasivo. Imagen adaptada de [Sadowski, Tejeda et al., MNRAS 2016](https://ui.adsabs.harvard.edu/abs/2016MNRAS.458.4250S/abstract).*
{: .img-caption}

**Investigador por México (SECIHTI) — Instituto de Física y Matemáticas, UMSNH**

Mi trabajo se centra en la astrofísica teórica y numérica, con especial interés en la física de acreción hacia agujeros negros y el desarrollo de métodos computacionales para fluidos relativistas.
...
Complemento mi labor de investigación con una participación activa como docente y tutor en los posgrados en Física de la UMSNH y de Astrofísica en la UNAM, así como en la organización de proyectos de difusión y divulgación científica.
